const courseDB = {
  ...
  "general": {
    "校核心必修": [{n:"中文閱讀與書寫",c:4},{n:"英文",c:4},{n:"體育",c:2}],
    "通識-文史哲藝術": [ {n:"休閒地理",c:2}, {n:"日治期的臺日經典文學",c:2}, {n:"從近代史看東亞思維",c:2}, {n:"攝影藝術",c:2}, {n:"美感與生活",c:2}, {n:"運動的藝術與實踐",c:2}, {n:"文學與現代生活",c:2}, {n:"旅遊英文",c:2}, {n:"歌唱治療",c:2}, {n:"影像藝術思維",c:2}, {n:"職場英文",c:2}, {n:"時事英文",c:2}, {n:"運動知能與欣賞",c:2}, {n:"英文小品文賞析",c:2}, {n:"兒童文學與閱讀",c:2}, {n:"14~17世紀歐洲文明史",c:2}, {n:"民俗與藝術",c:2}, {n:"禪學與人生",c:2}, {n:"小說與社會關懷",c:2}, {n:"臺灣女性散文選讀",c:2} ],
    "通識-社會脈動": [ {n:"財經時事分析與投資實務",c:2}, {n:"世界經濟趨勢與發展",c:2}, {n:"全球化與兩岸經貿關係",c:2}, {n:"全球化與公民素養",c:2}, {n:"國防政策",c:2}, {n:"領導藝術",c:2}, {n:"國際關係發展與理論",c:2}, {n:"國際體系變遷與臺灣安全",c:2}, {n:"法律素養",c:2}, {n:"犯罪、法律與人權",c:2}, {n:"性別與社會",c:2}, {n:"亞太地區地緣政治與中國",c:2}, {n:"政治學概要",c:2}, {n:"理財規劃",c:2}, {n:"金融創新-ETF投資",c:2}, {n:"全民國防",c:2}, {n:"實用法律與思辨",c:2}, {n:"愛情與法律",c:2}, {n:"在地文創與社區",c:2}, {n:"電影中的法律",c:2} ],
    "通識-生命科學": [ {n:"醫學與保健",c:2}, {n:"微生物與生活",c:2}, {n:"生態與文明",c:2}, {n:"環境污染與健康",c:2}, {n:"國家公園概論",c:2}, {n:"生態旅遊與保育",c:2}, {n:"疾病徵兆及認識",c:2}, {n:"環境教育概論",c:2}, {n:"鳥類生態與保育",c:2}, {n:"水資源利用與保育",c:2}, {n:"生命教育",c:2}, {n:"直排輪入門",c:2}, {n:"競技飛盤",c:2}, {n:"植物與人生",c:2}, {n:"運動與人生",c:2}, {n:"海洋生命科學導論",c:2}, {n:"大學生的幸福學",c:2}, {n:"尋找安平追想曲中的海洋",c:2}, {n:"癌症預防與生活",c:2}, {n:"生命實踐的對話",c:2}, {n:"生死學",c:2}, {n:"運動與體重控制",c:2}, {n:"樂活人生規劃",c:2} ],
